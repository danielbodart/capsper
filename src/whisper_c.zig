...
pub const whisper_vad_detect_speech_no_reset = cimport.whisper_vad_detect_speech_no_reset;
pub const whisper_vad_reset_state = cimport.whisper_vad_reset_state;
